...
package io.vit.vitio.Fragments.StartScreens;
...
public class LoginFragment extends Fragment implements ConnectAPI.RequestListener {
    ...
    private EditText regnoCol, dateCol, monthCol, yearCol, phoneCol,passCol;
    ...
    private void init(ViewGroup rootView) {
        ...
        passCol = (EditText) rootView.findViewById(R.id.pass_col);
    ...
    private void saveData() {
        ...
        dataHandler.savePassword(passCol.getText().toString());
        String campus;
    ...
    private boolean validate() {
        ...
        if (passCol.getText().toString().length() < 6) {
    ...
    public boolean isFieldEmpty() {
        ...
        if (passCol.getText().toString().equals("") || passCol.getText() == null) {
            i = true;
        }
        return i;
