...
public class SubjectViewFragmentTrial extends Fragment implements View.OnClickListener {
    ...
    private CustomFloatingActionsMenu floatingMenu;
    ...
    private void init(ViewGroup rootView) {
        ...
        coursePageFab = (FloatingActionButton) rootView.findViewById(R.id.course_page_fab);
        //reminderFab = (FloatingActionButton) rootView.findViewById(R.id.reminder_fab);
        floatingMenu = (CustomFloatingActionsMenu) rootView.findViewById(R.id.left_labels);
    ...
    private void setInit() {
        ...
        floatingMenu.setOnFloatingActionsMenuUpdateListener(new CustomFloatingActionsMenu.OnFloatingActionsMenuUpdateListener() {
            @Override
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.course_page_fab:
                floatingMenu.collapseImmediately();
                Intent intent2 = new Intent(getActivity(), CoursePageActivity.class);
    ...
    public void onResume() {
        ...
        theme.refreshTheme();
        collapsingToolbarLayout.setContentScrimColor(theme.getTodayHeaderColor());
        setFonts();
    }
