...
public class CustomAddFloatingActionButton extends CustomFloatingActionButton {
    int mPlusColor;

    public CustomAddFloatingActionButton(Context context) {
        this(context, null);
    }

    public CustomAddFloatingActionButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomAddFloatingActionButton(Context context, AttributeSet attrs, int defStyle) {
