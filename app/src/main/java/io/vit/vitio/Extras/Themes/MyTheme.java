...
public class MyTheme {
    ...
    public int getTodayHeaderColor() {
        if (appContext != null) {
            ...
            return R.drawable.today_head_bg_standard;
        }
    }
    ...
    public int getMyThemeMainColor() {
    ...
    public int getMyThemeDrawerIconsTypedArray() {
        if (appContext != null) {
            switch (themeCode) {
                case 0:
                    return R.array.drawer_icons_stand;
                case 1:
                    return R.array.drawer_icons_classic;
                case 2:
                    return R.array.drawer_icons_indigo;
                case 3:
                    return R.array.drawer_icons_mono;
                default:
                    return R.array.drawer_icons_stand;
    ...
    public int getMyThemeRoundedStrokeBackground() {
        switch (themeCode) {
            case 0:
                return R.drawable.stroke_rec_standard;
            case 1:
                return R.drawable.stroke_rec_classic;
            case 2:
                return R.drawable.stroke_rec_indigo;
            case 3:
                return R.drawable.stroke_rec_mono;
            default:
                return R.drawable.stroke_rec_standard;
        }
    }

    public int getMyThemeRoundedSolidBackground() {
        switch (themeCode) {
            case 0:
                return R.drawable.round_violet;
            case 1:
                return R.drawable.round_gray;
            case 2:
                return R.drawable.round_indigo;
            case 3:
