...
public class CustomFloatingActionsMenu extends ViewGroup {
    ...
    private CustomAddFloatingActionButton mAddButton;
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mAddButtonSize = attr.getInt(R.styleable.FloatingActionsMenu_fab_addButtonSize, CustomFloatingActionButton.SIZE_NORMAL);
    ...
    public void setMenuButtonColor(int colorId){
        mAddButtonColorNormal= ContextCompat.getColor(context,colorId);
        createAddButton(context);
    }
}
