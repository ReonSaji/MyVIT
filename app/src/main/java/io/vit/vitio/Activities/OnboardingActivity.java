...
import io.vit.vitio.Fragments.StartScreens.DetailFragment;
import io.vit.vitio.Fragments.StartScreens.LoginFragment;
...
public class OnboardingActivity extends AppCompatActivity {
    ...
    private void toggleCircle(ImageView imon, ImageView imoff[]) {
        ...
        animatorSet.start();
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20, getResources().getDisplayMetrics()), (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, getResources().getDisplayMetrics()));
        if (imon != im5)
