...
public class MarksActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //Declare Headers
    private TextView quiz1Head, quiz2Head, quiz3Head, cat1Head, cat2Head, assignmentHead, internalsHead,finalAssessmentHead, cgpaHead, qouteHead, qouteWriter, errorMessage;

    //Declare Contents
    private TextView quiz1Marks, quiz2Marks, quiz3Marks, cat1Marks, cat2Marks, assignmentMarks, internalsMarks, cgpaContent, finalAssessmentMarks;

    private LinearLayout cat1Indicator, cat2Indicator, internalsIndicator, finalAssessmentIndicator, layoutContainer;
    ...
    private void setData() {
        if (getIntent().hasExtra("class_number")) {
            ...
            if (markList != null&&markList.size()!=0) {
                ...
                if(markList.size()==1){
                    if (markList.get(0).getMARK() != null && !markList.get(0).getMARK().isEmpty() && !markList.get(0).getMARK().equals("null")) {
                        //labMarks.setText(markList.get(0).getMARK() + "/100");
                        internalsFlag = true;
                    ...
                    if (markList.get(1).getMARK() != null && !markList.get(1).getMARK().isEmpty() && !markList.get(1).getMARK().equals("null")) {
                        internalsFlag = true;
                    ...
                    if (markList.get(2).getMARK() != null && !markList.get(2).getMARK().isEmpty() && !markList.get(2).getMARK().equals("null")) {
                        internalsFlag = true;
                        tempInternals = tempInternals + (float) (Float.parseFloat(markList.get(2).getMARK()));
                        quiz1Marks.setText(markList.get(2).getMARK() + "/5");
                    }
                    if (markList.get(3).getMARK() != null && !markList.get(3).getMARK().isEmpty() && !markList.get(3).getMARK().equals("null")) {
                        internalsFlag = true;
                        tempInternals = tempInternals + (float) (Float.parseFloat(markList.get(3).getMARK()));
                        quiz2Marks.setText(markList.get(3).getMARK() + "/5");
                    }
                    if (markList.get(4).getMARK() != null && !markList.get(4).getMARK().isEmpty() && !markList.get(4).getMARK().equals("null")) {
                        internalsFlag = true;
                        tempInternals = tempInternals + (float) (Float.parseFloat(markList.get(4).getMARK()));
                        quiz3Marks.setText(markList.get(4).getMARK() + "/5");
                    }
                    if (markList.get(5).getMARK() != null && !markList.get(5).getMARK().isEmpty() && !markList.get(5).getMARK().equals("null")) {
                        internalsFlag = true;
                    ...
                    if (markList.get(6).getMARK() != null && !markList.get(6).getMARK().isEmpty() && !markList.get(6).getMARK().equals("null")) {
                        internalsFlag = true;
                        assignmentMarks.setText(markList.get(6).getMARK() + "/5");
                    }
